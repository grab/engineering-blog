...
<div class="post-image-section"><figure>
  <img src="/img/democratizing-fare-storage-at-scale-using-event-sourcing/image10.jpg" alt="Sample Fare Event">
</figure></div>
...
Clients of the fare life cycle read the current fare and create events to change the fare value as per their logic. Clients also access fare events, when required. This pattern enable clients to modify independent fares, and give them visibility to the sequence for different business needs.
